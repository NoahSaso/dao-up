...
pub enum ExecuteMsg {
    ...
    /// Change the minter for this token. Only the current minter may
    /// call this. The cap for the number of tokens that can be minted
    /// will remain the same as was initially configured.
