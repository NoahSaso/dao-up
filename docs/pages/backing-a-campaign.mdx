...
This guide assumes no prior knoledge about blockchains or Juno. DAO
Up! is for everyone. If you are already familiar with Juno and own
some feel free to skip to the [backing a
campaign](#backing-a-campaign) section.
...
less environmental impact that many other popular blockchains.
...
We reccomend using the [Keplr](https://keplr.app) wallet. It is just a
browser extension. You can go ahead and install it and come back to
this page.
...
viewing your addresss.

On a blockchain your address is what identifies you. You can publish
your address and connect it to your real identify or keep it
secret. If you ever want another address all you need to do is create
another account in Keplr.

Keplr supports many blockchains which are part of the [Cosmos
network](https://cosmos.network/). All you need to know about that is
that you'll have a different address on each chain.

To view your Juno address click the puzzle icon in the top left of
your browser and then click the Keplr icon. At first your wallet will
show your balance and address on the "Cosmos Hub". To view your
balance on the Juno network click the letters which say "Cosmos Hub"
at the top, scroll down to the word "Juno", and click that.
...
amount of Juno you'd like to support the campaign with, and press the
...
1. When you contribute to the campaign you'll receive a number of
   fundraising tokens porportional to the percentage of the funding
...
3. Once the campaign is complete you can return your fundraising
   tokens in return for voting tokens in the DAO.
...
If at any point before the campaign reaches its funding goal you can
...
Once you have swapped your fundraising tokeks for DAO governance
tokens you visit the DAO that you're part of by pressing the "Visit
the DAO" page on the campaign view page. To vote in a DAO DAO DAO you
will need to stake your tokens to the DAO. Make sure to follow the
prompt on the right side of the DAO DAO UI and stake your tokens.
